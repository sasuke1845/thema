...
display_welcome() {
  ...
  echo -e "${YELLOW}[+]                  © Flixxofficiall                    [+]${NC}"
  echo -e "${YELLOW}[+]                                                 [+]${NC}"
  echo -e "${YELLOW}[+] =============================================== [+]${NC}"
  echo -e ""
...
uninstall_theme() {
  ...
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  bash <(curl https://raw.githubusercontent.com/RuztanHosting/RuzPrivat/main/repair.sh)
  echo -e "                                                       "
  echo -e "${GREEN}[+] =============================================== [+]${NC}"
...
while true; do
  ...
  echo -e "                                                       "
echo -e "${RED}╔╦╦╦╦╦╦╦╦╦╦╗                               ${NC}"
echo -e "${RED}╠╬╬╬╬╬╬╬╬╬╬╣       Auto Installer Flixx officiall ${NC}"
echo -e "${RED}╠╬╬█╬╬╬╬█╬╬╣       ======================= ${NC}"
echo -e "${RED}╠╬╬╬╬╬╬╬╬╬╬╣        Support By Flixxofficiall   ${NC}"
echo -e "${RED}╠╬████████╬╣         Tele: @FlixxOfficiall       ${NC}"
echo -e "${RED}╠╬█╬╬╬╬╬╬█╬╣         YT: Flixx Hosting        ${NC}"
echo -e "${RED}╚╩╩╩╩╩╩╩╩╩╩╝                              ${NC}"
  echo -e "                                                       "
